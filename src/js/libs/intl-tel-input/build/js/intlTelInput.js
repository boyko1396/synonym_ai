  ...
  var Iti = class {
        ...
        if (allowDropdown) {
          ...
          if (countrySearch) {
            this.searchInput = createEl(
              ...
              {
                type: "text",
                class: "iti__search-input u-input__el u-input__el--size-md u-input__el--theme-grey-outline",
          ...
          this.countryList = createEl(
            "ul",
            {
              class: "u-scrollbar iti__country-list",
    ...
    _appendListItems() {
      for (let i = 0; i < this.countries.length; i++) {
        ...
        if (this.options.showFlags) {
          content += `<div class='iti__flag-box'><div class='iti__flag-wrapper'><div class='iti__flag iti__${c.iso2}'></div></div></div>`;
        }
    ...
    _setCountry(iso2) {
      ...
      if (this.selectedCountryInner) {
        ...
        this.selectedCountryInner.innerHTML = '';
        ...
        wrapper.className = 'iti__flag-wrapper';

        const flagDiv = document.createElement('div');
        flagDiv.className = flagClass;

        const a11ySpan = document.createElement('span');
        a11ySpan.className = 'iti__a11y-text';
        a11ySpan.textContent = a11yText;

        flagDiv.appendChild(a11ySpan);
        
        wrapper.appendChild(flagDiv);

        this.selectedCountryInner.appendChild(wrapper);
      }
